...
with(this){return _c('ol',[_c('li',[_v("User enters the last met overdue duration to the new desired value.")]),_v(" "),_c('li',[_v("ClientCare updates the new last met overdue duration.")]),_v(" "),_c('li',[_v("ClientCare refreshes the Last Met Display for all clients that meets the new last met overdue duration."),_c('br'),_v("\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("User marks an appointment with client as done.")]),_v(" "),_c('li',[_v("ClientCare updates appointment has done.")]),_v(" "),_c('li',[_v("ClientCare shifts the client from the Schedule Display to Last Met Display if his last met date is still overdue."),_c('br'),_v("\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Fri, 12 Apr 2024, 2:58:38 GMT+8]")])])])}
}];
